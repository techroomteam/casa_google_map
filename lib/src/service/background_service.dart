...
class BackgroundService {
  ...
  Future<void> startBackgroundTracking(
      {required void Function() listenDeviceLocation}) async {
    ...
    await _fBservice.configure(
      androidConfiguration: AndroidConfiguration(
        ...
        onStart: (serviceInstance) => _startBackgroundService(
          serviceInstance,
          listenDeviceLocation: listenDeviceLocation,
        ),
        // auto start service
        autoStart: true,
      ...
      iosConfiguration: IosConfiguration(
        ...
        onForeground: (serviceInstance) => _startBackgroundService(
          serviceInstance,
          listenDeviceLocation: listenDeviceLocation,
        ),
  ...
  void _startBackgroundService(ServiceInstance service,
